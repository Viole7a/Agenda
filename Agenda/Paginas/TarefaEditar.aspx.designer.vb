...
Partial Public Class TarefaEditar
    ...
    '''<summary>
    '''Controle drpTipoTarefa.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Modificar a declaração do campo de movimento do arquivo de designer para o arquivo code-behind.
    '''</remarks>
    Protected WithEvents drpTipoTarefa As Global.System.Web.UI.WebControls.DropDownList
    ...
    '''Modificar a declaração do campo de movimento do arquivo de designer para o arquivo code-behind.
    '''</remarks>
    Protected WithEvents txtDescricao As Global.System.Web.UI.HtmlControls.HtmlTextArea
    ...
    '''<summary>
    '''Controle drpPrioridade.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Modificar a declaração do campo de movimento do arquivo de designer para o arquivo code-behind.
    '''</remarks>
    Protected WithEvents drpPrioridade As Global.System.Web.UI.WebControls.DropDownList

    '''<summary>
    '''Controle btnIncluirTarefa.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Modificar a declaração do campo de movimento do arquivo de designer para o arquivo code-behind.
